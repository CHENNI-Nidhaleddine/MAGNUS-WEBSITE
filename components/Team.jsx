...
export default function Team() {
    return (
        <div id="team" data-aos="zoom-in" className="relative flex flex-col items-center justify-center lg:px-16 w-full lg:h-[calc(70vh)] px-10  h-full py-10 lg:py-auto">
